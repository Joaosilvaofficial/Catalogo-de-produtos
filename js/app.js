...
async function carregarProdutos() {
    ...
    produtosFiltrados = [...produtos] //Spread Operator / Operador de Espelhamento
    preencherMarcas()
    atualizarCatalogo()
}
...
function ordenarProdutos() {
    ...
    switch (criterio) {
        case 'nome': produtosFiltrados.sort((a, b) => a.nome.localeCompare(b.nome))
            break
        case 'menor': produtosFiltrados.sort((a, b) => a.preco - b.preco)
            break
        case 'maior': produtosFiltrados.sort((a, b) => b.preco - a.preco)
            break
    }
}
